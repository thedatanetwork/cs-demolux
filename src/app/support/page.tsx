...
export async function generateMetadata(): Promise<Metadata> {
  const page = await dataService.getPage('support');

  if (!page) {
    return {
      title: 'Support - Demolux',
      description: 'Get help with your products, find answers to common questions, and access technical support resources.'
    };
  }

  return {
    title: `${page.title} - Demolux`,
    description: page.meta_description || 'Get help with your products, find answers to common questions, and access technical support resources.'
  };
}
            ...
            <div className="relative container-padding section-spacing">
              <div className="max-w-5xl mx-auto text-center">
                <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 mb-8">
                  ...
                  <span className="text-sm font-medium text-white/90">Customer Support</span>
                </div>
        ...
        {page.content_sections && page.content_sections.length > 0 && (
          <>
            {page.content_sections.map((section, index) => (
              <section
                key={index}
                className={`section-spacing relative ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}
              >
          ...
          <div className="container-padding">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl mb-8 opacity-90">
                Our expert support team is ready to help you get the most from your Demolux products.
              </p>
