...
export async function generateMetadata(): Promise<Metadata> {
  const page = await dataService.getPage('terms');

  if (!page) {
    return {
      title: 'Terms of Service - Demolux',
      description: 'Review the terms and conditions governing your use of Demolux products and services.'
    };
  }

  return {
    title: `${page.title} - Demolux`,
    description: page.meta_description || 'Review the terms and conditions governing your use of Demolux products and services.'
  };
}
