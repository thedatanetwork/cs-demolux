...
export async function generateMetadata(): Promise<Metadata> {
  const page = await dataService.getPage('shipping');

  if (!page) {
    return {
      title: 'Shipping & Returns - Demolux',
      description: 'Learn about our white-glove delivery service and hassle-free returns policy.'
    };
  }

  return {
    title: `${page.title} - Demolux`,
    description: page.meta_description || 'Learn about our white-glove delivery service and hassle-free returns policy.'
  };
}
            ...
            <div className="relative container-padding section-spacing">
              <div className="max-w-5xl mx-auto text-center">
                <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 mb-8">
                  ...
                  <span className="text-sm font-medium text-white/90">Delivery & Returns</span>
                </div>
          ...
          <div className="container-padding">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl mb-8 opacity-90">
                Our customer experience team is ready to assist with shipping or returns questions.
              </p>
