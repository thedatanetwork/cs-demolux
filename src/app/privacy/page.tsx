...
export async function generateMetadata(): Promise<Metadata> {
  const page = await dataService.getPage('privacy');

  if (!page) {
    return {
      title: 'Privacy Policy - Demolux',
      description: 'Learn how Demolux protects and handles your personal information with care and precision.'
    };
  }

  return {
    title: `${page.title} - Demolux`,
    description: page.meta_description || 'Learn how Demolux protects and handles your personal information with care and precision.'
  };
}
          ...
          <div className="container-padding">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl mb-8 opacity-90">
                Our team is here to address any privacy concerns or questions you may have.
              </p>
