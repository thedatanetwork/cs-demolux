...
# CONTENTSTACK_PREVIEW_HOST=             # Optional - SDK auto-detects from region. Only set to override.

# Client-side config (NEXT_PUBLIC_ prefix for browser access)
NEXT_PUBLIC_CONTENTSTACK_API_KEY=        # Same as CONTENTSTACK_API_KEY
NEXT_PUBLIC_CONTENTSTACK_DELIVERY_TOKEN= # Same as CONTENTSTACK_DELIVERY_TOKEN
NEXT_PUBLIC_CONTENTSTACK_ENVIRONMENT=dev
NEXT_PUBLIC_CONTENTSTACK_REGION=US       # Same as CONTENTSTACK_REGION
...
# NEXT_PUBLIC_CONTENTSTACK_PREVIEW_HOST=  # Optional - SDK auto-detects from region. Only set to override.
